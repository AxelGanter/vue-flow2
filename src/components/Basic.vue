...
const elements = ref<Elements>([
  { id: '1', type: 'input', label: 'neuer Interessent', position: { x: 250, y: 5 } },
  { id: '2', type: 'output', label: 'Axel', position: { x: 100, y: 100 } },
  { id: '3', label: 'Node 3', position: { x: 400, y: 100 } },
  { id: '4', label: 'Node 4', position: { x: 150, y: 200 } },
  { id: '5', type: 'output', label: 'Ende', position: { x: 300, y: 300 } },
